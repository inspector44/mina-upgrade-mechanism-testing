...
REPO_COMPONENT="umt"
MINA_PACKAGE="mina-devnet-hardfork=2.0.0umt-hardfork-automation-umt-eb0a6d0"
...
#Stopping pre-upgrade and backup
mina client stop
...
# No need to generate the new one for post upgrade, so that it is skipped
...
[Service]
Environment="PEERS_LIST_URL=https://storage.googleapis.com/o1labs-gitops-infrastructure/o1labs-umt-post-fork-run-1/seeds-o1labs-umt-post-fork-run-1.txt"
